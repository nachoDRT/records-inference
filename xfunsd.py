...
class XFUN(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        zip_file_path = os.path.join(os.getcwd(), "XFunsd_Nacho.zip")
        downloaded_zip = dl_manager.extract(zip_file_path)
        downloaded_files = {}
        downloaded_files['train'] = [os.path.join(downloaded_zip, "XFunsd_Nacho", "es_train_json"), os.path.join(downloaded_zip, "XFunsd_Nacho", "es_train")]
        downloaded_files['eval'] = [os.path.join(downloaded_zip,  "XFunsd_Nacho", "es_eval_json"), os.path.join(downloaded_zip, "XFunsd_Nacho", "es_eval")]
        # downloaded_files = dl_manager.download_and_extract(urls_to_download)
        print("Downloaded file", downloaded_files)
        ...
        print("WHAT YOU NEED", train_files_for_many_langs)
    ...
    def _get_dataset_labels(self):
        ...
        trunsd_labels, names_labels = self._expand_labels_with_academic_years(trunsd_labels, expanded_tags, names_labels)
    ...
    def _expand_labels_with_academic_years(self, trunsd_labels: list, academic_years: list, names_labels: list):
